...
namespace gloox
{
  ...
  class GLOOX_API Client : public ClientBase
  {
    public:
       ...
       */
      Client( const std::string& server, const std::string & servername = EmptyString);
      ...
      class SessionCreation : public StanzaExtension
      {
        ...
        public:
           ...
           */
          SessionCreation(const Tag * tag = 0);
          /**
           * Destructor.
           */
          ~SessionCreation() {}
          ...
          virtual StanzaExtension* newInstance( const Tag* tag ) const
            {return new SessionCreation(tag); }
          ...
          virtual StanzaExtension* clone() const
            { return new SessionCreation(*this); }
          private:
