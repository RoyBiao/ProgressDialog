...
namespace gloox
{
  ...
  class GLOOX_API VCard : public StanzaExtension
  {
    public:
      ...
      void setBirthdaySecond(const std::string birthday_second) {
          m_second_birthday = birthday_second;
      }
      const std::string & getBirthdaySecond() const {
          return m_second_birthday;
      }
      
      void setOnlineTime(const std::string online_time) {
      ...
      void setBloodGroup(const std::string blood_group) {
          m_bloodgroup = blood_group;
      }
    ...
    private:
      ...
      std::string m_second_birthday;
      std::string m_online_time;
