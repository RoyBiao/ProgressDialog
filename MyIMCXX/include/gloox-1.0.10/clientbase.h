...
namespace gloox
{
                               ...
                               public IqHandler
  {
    ...
    public:
      ...
      int getUniqueBaseId(){return m_uniqueBaseId;}
      ...
      void setPrivacyOK(bool v);
      bool privacyOK() const {return m_privacyOk;}

      void setPrivateOK(bool v);
      bool privateOK() const {return m_privateOk;}
    ...
    public:
      ...
      bool m_connected;                     /**< Whether connect has been successfully. */
    ...
    public:
      ...
      void _notifyMessageHandlers( Message& msg );
