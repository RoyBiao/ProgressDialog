...
namespace gloox
{
                            ...
                            public IqHandler, private MessageHandler, private DiscoNodeHandler
  {
    public:
      ...
      const std::string passwd() const {return m_password;}
      ...
      void setSysGrp(const std::string& sys_grp);
      
      std::string sysGrp() const {return m_sys_grp;}

      void setIsCreate(bool v) {m_isCreate = v;}
      ...
      virtual bool joined() const {return m_joined;}
...
/**
      ...
      class MUCAdmin : public StanzaExtension
      {
        public:
          ...
          MUCAdmin( MUCRoomAffiliation affiliation, const JID & jid,
                    const std::string& reason = EmptyString );
