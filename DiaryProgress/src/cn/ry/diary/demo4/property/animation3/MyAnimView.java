...
public class MyAnimView extends View {
	...
	private void startAnimation() {
		...
		ObjectAnimator anim2 = ObjectAnimator.ofObject(this, "color",
				new ColorEvaluator(), "#0000FF", "#FF0000", "#0000FF");
//		anim2 = ObjectAnimator.ofInt(this, "backgroundColor",
//				getResources().getColor(R.color.aliceblue), getResources()
//						.getColor(R.color.aquamarine),
