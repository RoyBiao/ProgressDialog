package cn.ry.diary.demo3.aldl.client;
...
import cn.ry.essence.demo01.aidl.service.Beauty;
import cn.ry.essence.demo01.aidl.service.RemoteBeauty;
...
public class AIDLClientActivity extends Activity implements OnClickListener {
	...
	String actionName = "cn.ry.essence.demo01.aidl.service.RemoteService";
	...
	public void onClick(View v) {
		if(v==this.btn_bind){
			...
			textView.setText("美女  姓名："+beauty.getName());
		}else if(v==this.btn_getAge){
			textView.setText("美女  年龄："+beauty.getAge());		
