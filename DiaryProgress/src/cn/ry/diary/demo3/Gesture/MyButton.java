		...
		mGesture = new GestureDetector(context,
				new GestureDetector.SimpleOnGestureListener() {
					...
					public boolean onDoubleTap(MotionEvent e) {
						...
						Toast.makeText(context, "双击事件", Toast.LENGTH_SHORT)
								.show();
						return true;
					}
					...
					public boolean onFling(MotionEvent e1, MotionEvent e2,
						...
						if (Math.abs(e1.getX() - e2.getX()) > 50) {
							...
							ObjectAnimator
									.ofFloat(MyButton.this, "translationX",
											getTranslationX(),
											e2.getX() - e1.getX())
					...
					public boolean onScroll(MotionEvent e1, MotionEvent e2,
						...
						// 根据手势拖拽控件的相位而移动控件
						setTranslationX(getTranslationX() + e2.getX()
								- e1.getX());
						setTranslationY(getTranslationX() + e2.getY()
								- e1.getY());
