...
//    var t = current_selection.prop("tagName").toLowerCase();
    ...
    //}
    //var size = document.execCommand('fontSize', false);
    //alert("heading:// " + t);
    document.execCommand('fontSize', false, 8 - heading);
    
//    if (zss_editor.isUsingiOS) {
//        //window.location = "zss-callback/"+items.join(',');
//        window.location = "OSS://ASDFWAASassasd";
//    } else {
//        console.log("OSS://ASDFWAASassasd");
//    }
