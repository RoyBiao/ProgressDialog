...
public class ListFeatures2 {
  public static void main(String[] args) {
    ...
    List<Integer> pets = new ArrayList<Integer>(Arrays.asList(1,2,3,4,5,6,7,8));
    System.out.println("1: " + pets);
    pets.add(9); // Automatically resizes
    System.out.println("2: " + pets);
    System.out.println("3: " + pets.contains(9));
    pets.remove(Integer.valueOf(9));// Remove by object
    System.out.println("3: " + pets);
    Integer p = pets.get(2);
    System.out.println("4: " +  p + " " + pets.indexOf(p));
    Integer cymric = new Integer(1);
...
//    // Must be the exact object:
    ...
    pets.add(3, new Integer(111)); // Insert at an index
...
//    // Order is not important in containsAll():
    ...
    List<Integer> copy = new ArrayList<Integer>(pets);  //new 一个新的引用，直接赋值会改变pets的值
    ...
    Integer[] pa = pets.toArray(new Integer[10]);
